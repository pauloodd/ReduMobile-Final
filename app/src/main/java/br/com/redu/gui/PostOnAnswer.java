...
public final class PostOnAnswer extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.post_on_answer);
								...
								public void run() {
									if (posted != null && !posted.equals("") && !posted.contains("not authorized")) {
										...
										if(posted.contains("not authorized")){
											Toast.makeText(
													PostOnAnswer.this,
													"A operação desejada não pôde ser realizada, o usuário não autoriza postagens feitas por desconhecidos.",
													Toast.LENGTH_LONG).show();
										}else{
											Toast.makeText(
													PostOnAnswer.this,
													"A operação desejada não pôde ser realizada. Tente novamente",
													Toast.LENGTH_LONG).show();
										}
									}
