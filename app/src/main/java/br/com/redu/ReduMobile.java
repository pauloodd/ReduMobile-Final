...
public class ReduMobile extends Application {
    ...
    public final String CONSUMER_KEY = "solicite as suas credenciais no menu Aplicativos / Novo Aplicativo do Redu";
    public final String CONSUMER_SECRET = "solicite as suas credenciais no menu Aplicativos / Novo Aplicativo do Redu";
	...
	public void onCreate() {
		...
		this.externalFileDir = getExternalFilesDir(null).toString();
		singleton = this;
